    ...
    def suscribirse_a_topico(self):
        ...
        while self.is_running:
            try:
                ...
                fecha_hora = datetime.strptime(fecha_hora, "%H:%M:%S.%f")
                print(f"\nRecibido en: {topic}, Valor: {valor}, Fecha y hora: {fecha_hora}")
                
                # Se calcula el tiempo de retraso
                tiempo_final = datetime.strptime(datetime.now().strftime("%H:%M:%S.%f"), "%H:%M:%S.%f")
